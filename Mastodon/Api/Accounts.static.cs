...
namespace Mastodon.Api
{
    public class Accounts
    {
        ...
        /// </returns>
        public static async Task<Account> Fetching(string domain, int id, string token)
        {
        ...
        public static async Task<MastodonList<Account>> Followers(string domain, string token, int id, int max_id = 0,
            int since_id = 0, int limit = 40)
        {
            if (limit > 80 || limit < 0)
                throw new ArgumentOutOfRangeException($"{nameof(limit)}");
            return await HttpHelper.GetArrayAsync<Account>(
                $"{HttpHelper.HTTPS}{domain}{Constants.AccountsFollowers.Id(id.ToString())}", token, new[]
                {
        ...
        /// <returns>Returns an array of <see cref="AccountModel" /></returns>
        public static async Task<MastodonList<Account>> Following(string domain, string token, int id, int max_id = 0,
            int since_id = 0)
        {
            return await HttpHelper.GetArrayAsync<Account>(
        ...
        public static async Task<MastodonList<Status>> Statuses(string domain, string token, int id, int max_id = 0,
            int since_id = 0, bool only_media = false, bool exclude_replies = false)
        {
            return await HttpHelper.GetArrayAsync<Status>(
                $"{HttpHelper.HTTPS}{domain}{Constants.AccountsStatuses.Id(id.ToString())}", token, new[]
                {
                    (nameof(max_id), max_id.ToString()),
                    (nameof(since_id), since_id.ToString()),
        ...
        public static async Task<Relationship> Follow(string domain, string token, int id)
        {
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel" /></returns>
        public static async Task<Relationship> UnFollow(string domain, string token, int id)
        {
            return await HttpHelper.PostAsync<Relationship, HttpContent>(
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel" /></returns>
        public static async Task<Relationship> Block(string domain, string token, int id)
        {
            return await HttpHelper.PostAsync<Relationship, HttpContent>(
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel" /></returns>
        public static async Task<Relationship> UnBlock(string domain, string token, int id)
        {
            return await HttpHelper.PostAsync<Relationship, HttpContent>(
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel" /></returns>
        public static async Task<Relationship> Mute(string domain, string token, int id)
        {
            return await HttpHelper.PostAsync<Relationship, HttpContent>(
                $"{HttpHelper.HTTPS}{domain}{Constants.AccountsMute.Id(id.ToString())}", token, null);
        }
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel" /></returns>
        public static async Task<Relationship> UnMute(string domain, string token, int id)
        {
            return await HttpHelper.PostAsync<Relationship, HttpContent>(
        ...
        public static async Task<MastodonList<Relationship>> Relationships(string domain, string token, params int[] id)
        {
            return await HttpHelper.GetArrayAsync<Relationship>(
                $"{HttpHelper.HTTPS}{domain}{Constants.AccountsRelationships}", token,
                HttpHelper.ArrayEncode(nameof(id), id.Select(v => v.ToString()).ToArray()));
        }
        ...
        /// <returns>
        ///     Returns an array of matching <see cref="AccountModel" />. Will lookup an account remotely if the search term
        ...
        {
            return await HttpHelper.GetArrayAsync<Account>($"{HttpHelper.HTTPS}{domain}{Constants.AccountsSearch}",
                token, new[]
                {
                    (nameof(q), q),
                    (nameof(limit), limit.ToString())
