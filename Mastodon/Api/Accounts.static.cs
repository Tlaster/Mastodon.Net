...
namespace Mastodon.Api
{
    public partial class Accounts
    {
        ...
        {
            await HttpHelper.PatchAsync($"{HttpHelper.HTTPS}{domain}{Constants.AccountsUpdateCredentials}", token, new Dictionary<string, HttpContent>
            {
        ...
        {
            return await HttpHelper.GetArrayAsync<AccountModel>($"{HttpHelper.HTTPS}{domain}{Constants.AccountsFollowing.ID(id.ToString())}", token, new Dictionary<string, string>
            {
                { nameof(max_id), max_id.ToString() },
                { nameof(since_id), since_id.ToString() }
            });
        ...
        public static async Task<ArrayModel<StatusModel>> Statuses(string domain, string token, int id, int max_id = 0, int since_id = 0, bool only_media = false, bool exclude_replies = false)
        {
            return await HttpHelper.GetArrayAsync<StatusModel>($"{HttpHelper.HTTPS}{domain}{Constants.AccountsStatuses.ID(id.ToString())}", token, new Dictionary<string, string>
            {
                { nameof(max_id), max_id.ToString() },
                { nameof(since_id), since_id.ToString() },
        ...
        public static async Task<RelationshipModel> Follow(string domain, string token, int id)
        {
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel"/></returns>
        public static async Task<RelationshipModel> UnFollow(string domain, string token, int id)
        {
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel"/></returns>
        public static async Task<RelationshipModel> Block(string domain, string token, int id)
        {
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel"/></returns>
        public static async Task<RelationshipModel> UnBlock(string domain, string token, int id)
        {
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel"/></returns>
        public static async Task<RelationshipModel> Mute(string domain, string token, int id)
        {
        ...
        /// <param name="id">Account Id</param>
        /// <returns>Returns the target account's <see cref="RelationshipModel"/></returns>
        public static async Task<RelationshipModel> UnMute(string domain, string token, int id)
        {
        ...
        public static async Task<ArrayModel<RelationshipModel>> Relationships(string domain, string token, params int[] id)
        {
            return await HttpHelper.GetArrayAsync<RelationshipModel>($"{HttpHelper.HTTPS}{domain}{Constants.AccountsRelationships}", token, HttpHelper.ArrayEncode(nameof(id), id));
        }
        ...
        public static async Task<ArrayModel<AccountModel>> Search(string domain, string token, string q, int limit = 40)
        {
            return await HttpHelper.GetArrayAsync<AccountModel>($"{HttpHelper.HTTPS}{domain}{Constants.AccountsSearch}", token, new Dictionary<string, string>
            {
                { nameof(q), q },
                { nameof(limit), limit.ToString() }
            });
