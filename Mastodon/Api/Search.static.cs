...
namespace Mastodon.Api
{
    public class Search
    {
        ...
        /// <returns>
        ///     Returns <see cref="ResultsModel" />. If <see cref="q" /> is a URL, Mastodon will attempt to fetch the provided
        ...
        {
            return await HttpHelper.GetAsync<Results>($"{HttpHelper.HTTPS}{domain}{Constants.Search}", string.Empty,
                new[]
                {
                    (nameof(q), q),
